 ...
 */
public class SavableMeasurementActivity extends AbstractMeasurementActivity {
    private IMeasuredDetailsView measuredDetailsEditFragment;
    ...
    private void saveMeasurement() {
        measurementViewModel.addMeasurement(measuredDetailsEditFragment, measurement);
